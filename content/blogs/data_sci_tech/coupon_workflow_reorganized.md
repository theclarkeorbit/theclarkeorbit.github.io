...
```
## Error: 'train.csv' does not exist in current working directory ('/Users/prasanna/Library/CloudStorage/Dropbox/website/theclarkeorbit.github.io/content/_R').
```

``` r
campaign_data        <- readr::read_csv("campaign_data.csv")
```

```
## Error: 'campaign_data.csv' does not exist in current working directory ('/Users/prasanna/Library/CloudStorage/Dropbox/website/theclarkeorbit.github.io/content/_R').
```

``` r
coupon_item_mapping  <- readr::read_csv("coupon_item_mapping.csv")
```

```
## Error: 'coupon_item_mapping.csv' does not exist in current working directory ('/Users/prasanna/Library/CloudStorage/Dropbox/website/theclarkeorbit.github.io/content/_R').
```

``` r
customer_demo        <- readr::read_csv("customer_demographics.csv")
```

```
## Error: 'customer_demographics.csv' does not exist in current working directory ('/Users/prasanna/Library/CloudStorage/Dropbox/website/theclarkeorbit.github.io/content/_R').
```

``` r
customer_txn         <- readr::read_csv("customer_transaction_data.csv")
```

```
## Error: 'customer_transaction_data.csv' does not exist in current working directory ('/Users/prasanna/Library/CloudStorage/Dropbox/website/theclarkeorbit.github.io/content/_R').
```

``` r
item_data            <- readr::read_csv("item_data.csv")
```

```
## Error: 'item_data.csv' does not exist in current working directory ('/Users/prasanna/Library/CloudStorage/Dropbox/website/theclarkeorbit.github.io/content/_R').
```
...
```
## Error: object 'customer_txn' not found
```
...
```
## Error: object 'campaign_data' not found
```
...
```
## Error: object 'customer_txn_clean' not found
```
...
```
## Error: object 'cust_with_coupons' not found
```
...
```
## Error: object 'cust_camp_full' not found
```
...
```
## Error: object 'coupon_item_mapping' not found
```
...
```
## Error: object 'cust_camp' not found
```
...
```
## Error: object 'df_drugstore' not found
```
...
```
## Error: object 'sample_sizes' not found
```
...
```
## Error in eval(mf, parent.frame()): object 'df_drugstore' not found
```
...
```
## Error: object 'm_drug_naive' not found
```
...
```
## Error: object 'm_drug_adj' not found
```
...
```
## Error in eval(mf, parent.frame()): object 'df_ready2eat' not found
```
...
```
## Error: object 'm_ready_naive' not found
```
...
```
## Error: object 'm_ready_adj' not found
```
...
```
## Error: object 'naive_drug' not found
```
