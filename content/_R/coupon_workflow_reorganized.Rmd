...
```{r dag-visual, echo=TRUE, fig.width=5, fig.height=4, fig.align='center'}
...
```{r data-prep, results='hide', include=FALSE}
# =============================================================================
# LOAD DATA
# =============================================================================
train                <- readr::read_csv("~/projects/causal_talk_5thel/mlcausal_data/train.csv")
campaign_data        <- readr::read_csv("~/projects/causal_talk_5thel/mlcausal_data/campaign_data.csv")
coupon_item_mapping  <- readr::read_csv("~/projects/causal_talk_5thell/mlcausal_data/coupon_item_mapping.csv")
customer_demo        <- readr::read_csv("~/projects/causal_talk_5thel/mlcausal_data/customer_demographics.csv")
customer_txn         <- readr::read_csv("~/projects/causal_talk_5thel/mlcausal_data/customer_transaction_data.csv")
item_data            <- readr::read_csv("~/projects/causal_talk_5thel/mlcausal_data/item_data.csv")
...
```{r ate-comparison-plot, fig.width=8, fig.height=5}
