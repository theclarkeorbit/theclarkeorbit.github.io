...
```{r test-implications, echo=FALSE}
...
dag3_wrong |> 
  ...
  ggplot(aes(x = x, y = y, xend = xend, yend = yend)) +
  geom_dag_point(color = "#2D5016", size = 20, alpha = 0.4) +
  geom_dag_text(color = "black", size = 3.0) + geom_dag_edges(edge_colour = "#2D5016") +
  ggtitle(paste("The wrong DAG ")) +
  theme_dag() -> pwrong
pwrong
print("The implications: ")
